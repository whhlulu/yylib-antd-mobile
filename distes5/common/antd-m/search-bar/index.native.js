...
var SearchBar = function (_React$Component) {
    ...
    (0, _createClass3['default'])(SearchBar, [{
        ...
        value: function render() {
            ...
            return _react2['default'].createElement(_reactNative.View, { style: styles.wrapper }, _react2['default'].createElement(_reactNative.View, { style: styles.inputWrapper }, _react2['default'].createElement(_reactNative.TextInput, (0, _extends3['default'])({ value: value, onChangeText: this.onChangeText, style: [styles.input, style], editable: !disabled, ref: function ref(el) {
                    return _this2.inputRef = el;
                }, onSubmitEditing: this.onSubmit, clearButtonMode: 'always', underlineColorAndroid: 'transparent' }, restProps, { onFocus: this.onFocus, onBlur: this.onBlur }))), _react2['default'].createElement(_reactNative.Image, { source: require('../style/images/search.png'), style: styles.search, resizeMode: 'stretch' }), _showCancelButton && _react2['default'].createElement(_reactNative.View, { style: styles.cancelTextContainer }, _react2['default'].createElement(_reactNative.Text, { style: styles.cancelText, onPress: this.onCancel }, cancelText || _locale.cancelText)));
        }
    }]);
    return SearchBar;
