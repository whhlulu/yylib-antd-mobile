    ...
    (0, _createClass3['default'])(ImagePicker, [{
        ...
        value: function render() {
            ...
            files.forEach(function (image, index) {
                ...
                imgItemList.push(_react2['default'].createElement(_flex2['default'].Item, { key: 'item-' + index }, _react2['default'].createElement('div', { key: index, className: prefixCls + '-item' }, _react2['default'].createElement('div', { className: prefixCls + '-item-remove', role: 'button', 'aria-label': 'Click and Remove this image', onClick: function onClick() {
            ...
            var selectEl = _react2['default'].createElement(_flex2['default'].Item, { key: 'select' }, _react2['default'].createElement(_rmcFeedback2['default'], { activeClassName: prefixCls + '-upload-btn-active' }, _react2['default'].createElement('div', { className: prefixCls + '-item ' + prefixCls + '-upload-btn', onClick: onAddImageClick, role: 'button', 'aria-label': 'Choose and add image' }, _react2['default'].createElement('input', { ref: function ref(input) {
                    _this2.fileSelectorInput = input;
                }, type: 'file', accept: 'image/*', onChange: function onChange() {
                    _this2.onFileChange();
                }, multiple: multiple }))));
            ...
            var renderEl = flexEl.map(function (item, index) {
                return _react2['default'].createElement(_flex2['default'], { key: 'flex-' + index }, item);
            });
            return _react2['default'].createElement('div', { className: wrapCls, style: style }, _react2['default'].createElement('div', { className: prefixCls + '-list', role: 'group' }, renderEl));
        }
    }]);
    return ImagePicker;
