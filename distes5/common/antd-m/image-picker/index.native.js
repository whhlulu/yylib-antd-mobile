    ...
    (0, _createClass3['default'])(ImagePicker, [{
        ...
        value: function render() {
            ...
            var filesView = files.map(function (item, index) {
                return _react2['default'].createElement(_reactNative.View, { key: index, style: [styles.item, styles.size] }, _react2['default'].createElement(_reactNative.TouchableOpacity, { onPress: function onPress() {
                        return _this2.onImageClick(index);
                    }, activeOpacity: 0.6 }, _react2['default'].createElement(_reactNative.Image, { source: { uri: item.url }, style: [styles.size, styles.image] })), _react2['default'].createElement(_reactNative.TouchableOpacity, { onPress: function onPress() {
                        return _this2.removeImage(index);
                    }, style: styles.closeWrap, activeOpacity: 0.6 }, _react2['default'].createElement(_reactNative.Text, { style: styles.closeText }, '\xD7')));
            });
            ...
            return _react2['default'].createElement(_reactNative.View, { style: styles.container }, filesView, selectable && _react2['default'].createElement(_reactNative.TouchableWithoutFeedback, { onPress: this.showPicker, onPressIn: this.onPressIn, onPressOut: this.onPressOut }, _react2['default'].createElement(_reactNative.View, { ref: function ref(conponent) {
                    return _this2.plusWrap = conponent;
                }, style: [styles.item, styles.size, styles.plusWrap, styles.plusWrapNormal] }, _react2['default'].createElement(_reactNative.Text, { style: [styles.plusText] }, '+'))), this.state.visible ? imageRollEl : null);
        }
    }]);
    return ImagePicker;
