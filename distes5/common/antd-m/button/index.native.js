...
var Button = function (_React$Component) {
    ...
    (0, _createClass3['default'])(Button, [{
        ...
        value: function render() {
            ...
            return _react2['default'].createElement(_reactNative.TouchableHighlight, (0, _extends3['default'])({ activeOpacity: 1, underlayColor: underlayColor, style: wrapperStyle, onPress: function onPress(e) {
                    return onClick && onClick(e);
                }, onPressIn: this.onPressIn, onPressOut: this.onPressOut, onShowUnderlay: this.onShowUnderlay, onHideUnderlay: this.onHideUnderlay, disabled: disabled }, restProps), _react2['default'].createElement(_reactNative.View, { style: _styles.container }, loading ? _react2['default'].createElement(_reactNative.ActivityIndicator, { style: _styles.indicator, animating: true, color: indicatorColor, size: 'small' }) : null, _react2['default'].createElement(_reactNative.Text, { style: textStyle }, this.props.children)));
        }
    }]);
    return Button;
