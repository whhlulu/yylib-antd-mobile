...
var AlertContainer = function (_React$Component) {
    ...
    (0, _createClass3['default'])(AlertContainer, [{
        ...
        value: function render() {
            ...
            return _react2['default'].createElement(_Modal2['default'], { transparent: true, title: title, visible: this.state.visible, footer: footer, onAnimationEnd: onAnimationEnd }, _react2['default'].createElement(_reactNative.ScrollView, null, _react2['default'].createElement(_reactNative.Text, null, content)));
        }
    }]);
