        ...
        value: function render() {
            ...
            if (renderHeader) {
                ...
                if (typeof content === 'string') {
                    content = _react2['default'].createElement(_reactNative.Text, { style: _styles.Header }, content);
                }
            ...
            if (renderFooter) {
                ...
                if (typeof _content === 'string') {
                    _content = _react2['default'].createElement(_reactNative.Text, { style: _styles.Footer }, _content);
                }
                footerDom = _react2['default'].createElement(_reactNative.View, null, _content);
            }
            return _react2['default'].createElement(_reactNative.View, (0, _extends3['default'])({}, restProps, { style: style }), headerDom, _react2['default'].createElement(_reactNative.View, { style: _styles.Body }, children, _react2['default'].createElement(_reactNative.View, { style: [_styles.BodyBottomLine] })), footerDom);
        }
    }]);
    return List;
