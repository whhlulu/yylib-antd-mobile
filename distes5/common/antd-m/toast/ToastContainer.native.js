...
var ToastContainer = function (_React$Component) {
    ...
    (0, _createClass3['default'])(ToastContainer, [{
        ...
        value: function render() {
            ...
            return _react2['default'].createElement(_reactNative.View, { style: [styles.container], pointerEvents: mask ? undefined : 'box-none' }, _react2['default'].createElement(_reactNative.View, { style: [styles.innerContainer] }, _react2['default'].createElement(_reactNative.Animated.View, { style: { opacity: this.state.fadeAnim } }, _react2['default'].createElement(_reactNative.View, { style: [styles.innerWrap, iconDom ? styles.iconToast : styles.textToast] }, iconDom, _react2['default'].createElement(_reactNative.Text, { style: styles.content }, content)))));
        }
    }]);
