...
var WingBlank = function (_React$Component) {
    ...
    (0, _createClass3['default'])(WingBlank, [{
        ...
        value: function render() {
            ...
            var margin = _default2['default']['h_spacing_' + size];
            return _react2['default'].createElement(_reactNative.View, { style: [{ marginLeft: margin, marginRight: margin }, style] }, children);
        }
    }]);
    return WingBlank;
