...
var RNActivityIndicator = function (_React$Component) {
    ...
    (0, _createClass3['default'])(RNActivityIndicator, [{
        ...
        value: function _renderToast() {
            ...
            return _react2['default'].createElement(_reactNative.View, { style: [styles.container] }, _react2['default'].createElement(_reactNative.View, { style: [styles.innerContainer, { height: 89 }] }, _react2['default'].createElement(_reactNative.View, { style: [styles.wrapper] }, _react2['default'].createElement(_reactNative.ActivityIndicator, { color: 'white', size: 'large' }), this.props.text && _react2['default'].createElement(_reactNative.Text, { style: [styles.toast] }, this.props.text))));
        }
    }, {
        key: '_renderSpinner',
        value: function _renderSpinner() {
            ...
            return _react2['default'].createElement(_reactNative.View, { style: spinner }, _react2['default'].createElement(_reactNative.ActivityIndicator, { color: color, size: size }), text && _react2['default'].createElement(_reactNative.Text, { style: [tip] }, text));
        }
    }, {
        key: 'render',
