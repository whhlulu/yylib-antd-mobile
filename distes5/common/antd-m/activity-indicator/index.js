...
var ActivityIndicator = function (_React$Component) {
    ...
    (0, _createClass3['default'])(ActivityIndicator, [{
        ...
        value: function render() {
            ...
            if (animating) {
                if (toast) {
                    return _react2['default'].createElement('div', { className: wrapClass }, text ? _react2['default'].createElement('div', { className: prefixCls + '-content' }, _react2['default'].createElement('span', { className: spinnerClass, 'aria-hidden': 'true' }), _react2['default'].createElement('span', { className: prefixCls + '-toast' }, text)) : _react2['default'].createElement('div', { className: prefixCls + '-content' }, _react2['default'].createElement('span', { className: spinnerClass, 'aria-label': 'Loading' })));
                } else {
                    return text ? _react2['default'].createElement('div', { className: wrapClass }, _react2['default'].createElement('span', { className: spinnerClass, 'aria-hidden': 'true' }), _react2['default'].createElement('span', { className: prefixCls + '-tip' }, text)) : _react2['default'].createElement('div', { className: wrapClass }, _react2['default'].createElement('span', { className: spinnerClass, 'aria-label': 'loading' }));
                }
            } else {
                return null;
            }
