...
var Pagination = function (_React$Component) {
    ...
    (0, _createClass3['default'])(Pagination, [{
        ...
        value: function render() {
            ...
            var simpleItem = !simple ? _react2['default'].createElement(_flex2['default'].Item, null, _react2['default'].createElement(_reactNative.View, { style: [styles.numberStyle] }, _react2['default'].createElement(_reactNative.Text, { style: [styles.activeTextStyle] }, current), _react2['default'].createElement(_reactNative.Text, { style: [styles.totalStyle] }, '/', total))) : _react2['default'].createElement(_flex2['default'].Item, null);
            var markup = _react2['default'].createElement(_flex2['default'], null, _react2['default'].createElement(_flex2['default'].Item, null, _react2['default'].createElement(_button2['default'], { disabled: current <= 1, onClick: function onClick() {
                    return _this2.onChange(current - 1);
                } }, prevText)), simpleItem, _react2['default'].createElement(_flex2['default'].Item, null, _react2['default'].createElement(_button2['default'], { disabled: current >= total, onClick: function onClick() {
                    return _this2.onChange(current + 1);
                } }, nextText)));
            if (mode === 'number') {
                markup = _react2['default'].createElement(_reactNative.View, { style: [styles.numberStyle] }, _react2['default'].createElement(_reactNative.Text, { style: [styles.activeTextStyle] }, current), _react2['default'].createElement(_reactNative.Text, { style: [styles.totalStyle] }, '/', total));
