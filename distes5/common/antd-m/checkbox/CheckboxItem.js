...
var CheckboxItem = function (_React$Component) {
    ...
    (0, _createClass3['default'])(CheckboxItem, [{
        ...
        value: function render() {
            ...
            return _react2['default'].createElement(ListItem, (0, _extends3['default'])({}, restProps, { prefixCls: listPrefixCls, className: wrapCls, thumb: _react2['default'].createElement(_Checkbox2['default'], (0, _extends3['default'])({}, checkboxProps, extraProps)) }), children);
        }
    }]);
    return CheckboxItem;
