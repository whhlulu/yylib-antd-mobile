...
var AgreeItem = function (_React$Component) {
    ...
    (0, _createClass3['default'])(AgreeItem, [{
        ...
        value: function render() {
            ...
            return _react2['default'].createElement('div', (0, _extends3['default'])({}, (0, _getDataAttr2['default'])(restProps), { className: wrapCls, style: style }), _react2['default'].createElement(_Checkbox2['default'], (0, _extends3['default'])({}, restProps, { className: prefixCls + '-agree-label' })));
        }
    }]);
    return AgreeItem;
