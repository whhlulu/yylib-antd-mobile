...
var RadioItem = function (_React$Component) {
    ...
    (0, _createClass3['default'])(RadioItem, [{
        ...
        value: function render() {
            ...
            return _react2['default'].createElement(ListItem, (0, _extends3['default'])({}, otherProps, { prefixCls: listPrefixCls, className: wrapCls, extra: _react2['default'].createElement(_Radio2['default'], (0, _extends3['default'])({}, radioProps, extraProps)) }), children);
        }
    }]);
    return RadioItem;
