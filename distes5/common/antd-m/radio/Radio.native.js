...
var Radio = function (_React$Component) {
    ...
    (0, _createClass3['default'])(Radio, [{
        ...
        value: function render() {
            ...
            return _react2['default'].createElement(_reactNative.TouchableWithoutFeedback, { onPress: this.handleClick }, _react2['default'].createElement(_reactNative.View, { style: [styles.wrapper] }, _react2['default'].createElement(_reactNative.Image, { source: imgSrc, style: [styles.icon, style] }), typeof children === 'string' ? _react2['default'].createElement(_reactNative.Text, null, this.props.children) : children));
        }
    }]);
    return Radio;
