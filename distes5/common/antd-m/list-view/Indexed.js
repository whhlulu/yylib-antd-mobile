...
var MIndexedList = function (_React$Component) {
    ...
    (0, _createClass3['default'])(MIndexedList, [{
        ...
        value: function render() {
            ...
            return _react2['default'].createElement(IndexedList, (0, _extends3['default'])({ ref: function ref(el) {
                    return _this2.indexedListRef = el;
                }, sectionHeaderClassName: prefixCls + '-section-header ' + listPrefixCls + '-body', sectionBodyClassName: prefixCls + '-section-body ' + listPrefixCls + '-body' }, restProps, extraProps), this.props.children);
        }
    }]);
    return MIndexedList;
